...
The Blender submitter can be installed and automatically updated as a Blender add-on. Requires Blender 4.2 or newer. This add on and install method is still experimental. Use at your own risk.
...
2. Set the **URL** to `https://github.com/aws-deadline/deadline-cloud-for-blender/releases/latest/download/index.json`. If you want the extension to automatically update, check the box for **Check for Updates on Startup**. Click **Create**.
